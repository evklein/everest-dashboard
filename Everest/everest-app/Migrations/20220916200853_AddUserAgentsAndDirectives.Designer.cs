...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("everest_common.Models.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("UserAgentDirectiveId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserAgentDirectiveId");

                    b.ToTable("Tags");
                });

            modelBuilder.Entity("everest_common.Models.ToDoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("everest_common.Models.UserAgentDirective", b =>
                {
                    ...
                    b.Property<decimal?>("SecondsToRun")
            ...
            modelBuilder.Entity("everest_common.Models.Tag", b =>
                {
                    ...
                    b.HasOne("everest_common.Models.UserAgentDirective", null)
                        .WithMany("Tags")
                        .HasForeignKey("UserAgentDirectiveId");
            ...
            modelBuilder.Entity("NoteTag", b =>
                {
                    b.HasOne("everest_common.Models.Note", null)
                        .WithMany()
                        .HasForeignKey("NoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("everest_common.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TagToDoItem", b =>
                {
                    ...
                    b.HasOne("everest_common.Models.ToDoItem", null)
                        .WithMany()
